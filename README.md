...
[![CRAN status](https://www.r-pkg.org/badges/version/nowcast)](https://CRAN.R-project.org/package=nowcast) [![CRAN downloads](https://cranlogs.r-pkg.org/badges/nowcast)](https://CRAN.R-project.org/package=nowcast) [![Total Downloads](https://cranlogs.r-pkg.org/badges/grand-total/nowcast)](https://CRAN.R-project.org/package=nowcast) [![Lifecycle: stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)](https://lifecycle.r-lib.org/articles/stages.html#stable) [![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)

A technical working paper for this package can be found [here](https://charlescoverdale.github.io/files/coverdale_nowcast_2026.pdf).
